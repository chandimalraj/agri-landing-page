...
const pages = ["Home Page", "About Us", "Services", "Resources"];
  ...
  return (
    <>
      <AppBar
        position="fixed"
        sx={{
          backgroundColor: "rgba(25, 59, 51, 1)",
          border: "none",
          boxShadow: "none",

          borderBottom: "2px solid #151615",
        }}
      >
      ...
      <MegaMenu anchorEl={openMegaMenu} handleClose={handleMegaMenuClose} />
    </>
  );
}
